...
export function MobileBottomNav({ onContact }: { onContact: () => void }) {
    return (
        <div className="bg-card/90 border-border fixed right-0 bottom-0 left-0 z-40 flex items-center justify-around border-t px-6 py-2 backdrop-blur-md md:hidden">
            <a
                href="#home"
