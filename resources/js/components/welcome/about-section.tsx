...
export function AboutSection({ image, onContact }: AboutSectionProps) {
    ...
    return (
        <section
            id="about"
            className="bg-gradient-to-b from-background via-card/40 to-background py-20 lg:py-28"
        >
            <div className="container-site">
                <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
                    ...
                    >
                        <motion.div className="flex items-center gap-3" variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0 } }}>
                            <span className="text-muted-foreground text-xs font-semibold tracking-[0.25em] uppercase">
                                About Us
                            </span>
                            <div className="bg-gold/60 h-px w-8" />
                        </motion.div>
                        <motion.h2 className="font-display text-foreground text-3xl font-light leading-tight sm:text-4xl lg:text-5xl" variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0 } }}>
                            More than properties.
                            <br />
                            We build futures.
                        </motion.h2>
                        <motion.p className="text-muted-foreground text-sm leading-relaxed sm:text-base" variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0 } }}>
                    ...
                    <motion.div ref={imageRef} className="relative lg:col-span-7" initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: '-100px' }} transition={{ duration: 0.7 }}>
                        ...
                        <motion.div initial={{ opacity: 0, y: -12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-100px' }} transition={{ delay: 0.35, duration: 0.5 }} className="bg-card/95 border-border/80 absolute top-4 right-4 flex items-center gap-4 rounded-xl border p-4 shadow-xl backdrop-blur-md sm:top-6 sm:right-6 sm:p-5">
